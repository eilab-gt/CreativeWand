...
class HighlighterComm(BaseCommunication):
    ...
    def activate(self) -> bool:
        ...
        exp_manager.frontend.send_information(Req("Sentence [" + str(outlier) + "] stands out the most from the rest of the story in terms of content because of the word '" + word + ".' Maybe edit it or elaborate on it further!"))
